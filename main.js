window.addEventListener('load', function(){
    ...
    function spawnTounge(toungeWidth){
        var toungeGeometry = new THREE.SphereGeometry( 0.1,toungeWidth,0.1);
    ...
    var bodyGeometry = new THREE.SphereGeometry( objectWidth,100,100 );
    ...
    function spawnAppleStilk(){
        ...
        var stilkGeometry = new THREE.SphereGeometry( 0.04,0.04,1);
    ...
    function yum(){
        ...
        {
            myArray.push(spawnBody(0x6699ff));
        }
    }
    ...
    swal( "❌Sorry ❌","You fell from the floor\nYour score: " + eatVar + "\n\n😄 Better Luck Next Time😄");
    ...
    swal("🐍Welcome to Kaushik's 3D Snake Game 🐍" );
    pauseVar=1;
    scoreId.innerHTML = "◀️\nPress the Buttons to start\n▶️";
